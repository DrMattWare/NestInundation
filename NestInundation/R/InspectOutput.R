...
#' @example Summary_Table(HOBO = hoboData) where "hoboData" is the name of your processed dataframe (hoboData is the default name of the dataframe exported by Clean_Depth_Data())
#'
...
#' @example Event_Table(HOBO = hoboData) where "hoboData" is the name of your processed dataframe (hoboData is the default name of the dataframe exported by Clean_Depth_Data())
#'
...
#' @example Temperature_Table(HOBO = hoboData) where "hoboData" is the name of your processed dataframe (hoboData is the default name of the dataframe exported by Clean_Depth_Data())
#'
...
#' @return Tables formatted for export to separate Excel sheets
#' @example Export_Tables()
#'
