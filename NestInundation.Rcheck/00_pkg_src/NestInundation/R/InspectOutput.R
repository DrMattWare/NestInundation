...
#' Plot water level and temperature time-series
#'
...
#' Summarize inundation exposure across deployment
#'
...
#' Details of each inundation event
#'
#' @param HOBO The processed data to be summarized - Defaults to hoboData output by Clean_Depth_Data()
...
#' Summarize reported temperature across deployment
#'
#' @param HOBO The processed data to be summarized - Defaults to hoboData output by Clean_Depth_Data()
...
#' Prepare tables for export to Excel
#'
#' @param Data A variable set in the processing phase which determines what tables to prepare for export
#' @return Tables formatted for export to separate Excel sheets
#'
Export_Tables <- function(Data = inundationStart){
